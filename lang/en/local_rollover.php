...
$string['event_rollover_completed'] = 'Rollover completed';
$string['event_rollover_requested'] = 'Rollover requested';
$string['event_rollover_started'] = 'Rollover started';
...
$string['progress_loading'] = 'Read {$a}';
$string['progress_saving'] = 'Save {$a}';
...
$string['rolloversuccessfulwarn'] = 'Rollover successful with warnings';
$string['rolloversuccessfulwarnmessage'] = 'Course <b>{$a->from}</b> rolled over into <b>{$a->into}</b>, see warnings.';
...
$string['settings-protection-empty-text'] = 'Message if destination is not empty';
$string['settings-protection-hidden'] = 'If rollover destination is not hidden';
$string['settings-protection-hidden-text'] = 'Message if destination is not hidden';
...
$string['settings-protection-started-text'] = 'Message if destination has already started';
$string['settings-protection-students'] = 'If rollover destination contains students';
$string['settings-protection-students-text'] = 'Message if destination contains students';
$string['settings-select-allnone'] = 'Select all/none';
$string['settings-select-allnone-title'] = 'Display select all/none section';
$string['settings-select-allnone-description'] = 'If enabled, the options "select all/none" will be displayed when selecting activities for a rollover.';
$string['settings-saved'] = 'Settings saved.';
$string['settings-filter'] = 'Past instances filter';
$string['sourcecourse'] = 'Source course';
$string['sourcecourse_help'] = 'Provide the shortname for course to be used as a source for this rollover.';
$string['sourcecourse_mycourses'] = 'My courses:';
$string['sourcecourse_pastinstances'] = 'Past instances:';
$string['sourcecourse_search'] = 'Search';
$string['step_activities_and_resources'] = 'Rollover: Select activities and resources';
$string['step_complete'] = 'Performing rollover';

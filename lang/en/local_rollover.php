...
$string['settings-backup-location-description'] = 'Provide a path in the webserver where to save the rollover backup files.<br /><strong>Notice:</strong> If this path is changed, existing data will not be moved to the new location or cleaned up by cron.';

...
$string['precheck_user'] = 'The destionation course already has active users.';
...
$string['settings-protection-user'] = 'If rollover destination contains user data';
$string['settings-protection-user-description'] = 'Protects against rolling over a course in use';

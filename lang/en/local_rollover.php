...
$string['option_calendarevents'] = 'If enabled calendar events will be included in rollovers by default.';
...
$string['option_gradehistories'] = 'Sets the default for including user history within a rollover.';
...
$string['past_instances_examples'] = 'Examples of past instances for:';
...
$string['rule-sentence-1_forbid-activity-regex'] = 'Forbid rolling over any \'{$a->activity}\' matching: {$a->regex}';
$string['rule-sentence-2_enforce-all-all'] = 'Enforce rolling over all activities.';
$string['rule-sentence-2_enforce-all-regex'] = 'Enforce rolling over any activity matching: {$a->regex}';
$string['rule-sentence-2_enforce-activity-all'] = 'Enforce rolling over all \'{$a->activity}\' activities.';
$string['rule-sentence-2_enforce-activity-regex'] = 'Enforce rolling over any \'{$a->activity}\' matching: {$a->regex}';
$string['rule-sentence-3_not_default-all-all'] = 'Do not rollover by default any activity.';
$string['rule-sentence-3_not_default-all-regex'] = 'Do not rollover by default any activity matching: {$a->regex}';
$string['rule-sentence-3_not_default-activity-all'] = 'Do not rollover by default any \'{$a->activity}\' activity.';
$string['rule-sentence-3_not_default-activity-regex'] = 'Do not rollover by default any \'{$a->activity}\' matching: {$a->regex}';

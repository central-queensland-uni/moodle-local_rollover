 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class rollover_started extends base {
    /**
    ...
    public static function get_name() {
        return get_string('event_rollover_started', 'local_rollover');
    }
    ...
    public function get_description() {
        ...
        return "The user with the id '{$this->userid}' started to rollover course id '{$source}' into '{$destination}'";
    }
